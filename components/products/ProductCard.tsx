        ...
        >
...

            {
                isAvailable(product.inventory) ? (
                    ...
                    <p className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-60 w-full text-center py-5 text-2xl uppercase font-black">Agotado</p>
                )
            }
        </div>
    )
